...
// ✅ NEW: Mark attendance for staff
export const markStaffAttendance = async (staffId, attendanceData) => {
...
//  Fetch staff by personType (Site Staff or Labour Contractor)
export const fetchStaffByType = async () => {
  const res = await axiosInstance.get(`/api/staff/person`);
  return res.data || [];
};



// // Fetch staff by personType (Site Staff or Labour Contractor) for a specific project
// export const fetchStaffByType = async (projectId) => {
//   if (!projectId) throw new Error("projectId is required");

//   const res = await axiosInstance.get(`/api/staff/person?projectId=${projectId}`);
//   return res.data || [];
// };
