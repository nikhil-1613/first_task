...
function ProductCard({ product }) {
  ...
  try {
    ...
    console.log("📤 Sending payload to cart:", { userId, items });
    const response = await addToCartAPI(userId, items); // ✅ FIXED HERE
  ...
  //     if (!payload.userId || !cartItem._id || !cartItem.name || !cartItem.image || !cartItem.price || !cartItem.vendor) {
  //       toast.error("❌ Payload missing required fields");
  //       return;
  //     }
