...
function SubcategoryPage() {
  ...
  //         `${process.env.REACT_APP_API_BASE}/api/products?category=${categoryName}&subcategory=${readableSubcategory}`
  //       );
        ...
        <aside className="hidden md:block w-full lg:w-1/4 bg-white p-4 border rounded shadow-sm text-sm">
          ...
          <div className="mb-6">
            ...
            <label className="block">
              <input type="checkbox" className="mr-2" /> Laminates (12)
            </label>
            <label className="block">
              <input type="checkbox" className="mr-2" /> Veneers (5)
            </label>
          </div>
          ...
          <div className="mb-6">
            ...
            />
            <label className="block">
              <input type="checkbox" className="mr-2" /> Brown (6)
            </label>
            <label className="block">
              <input type="checkbox" className="mr-2" /> Grey (4)
            </label>
          </div>
