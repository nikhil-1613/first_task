...
const allFilters = [
  "Abstract Art", "Cane Textures", "Cement Look", "Digital Series",
  "Embossed Pattern", "Fabric Textures", "Fluted Laminates", "Fluted Panels",
  "Geometric & Abstracts", "Leather Effect", "Laminate","Marbles & Stones", "Metallic Finish",
  "Mirror Look", "Natural Rustic", "Plain Solids", "Shiny Sparkles",
  "Terrazzo", "Wave Pattern", "Wood & Laminate", "Wooden Effect"
];
