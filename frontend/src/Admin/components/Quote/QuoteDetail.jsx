...
import { fetchQuotes, addSummaryToQuote, fetchQuoteSummary } from "../../../services/quoteServices";
  ...
  useEffect(() => {
    const loadSummary = async () => {
      try {
        ...
        const dynamicSpaces = data.summary?.map((s) => s.space) || [];
...
//                 }
//                 try {
//                   await addSummaryToQuote(quoteId, summary);
//                   toast.success("Summary saved successfully");
//                   setShowAddSectionModal(false);
//                 } catch (err) {
//                   console.error("Error saving summary:", err);
