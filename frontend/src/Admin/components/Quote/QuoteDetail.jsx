...
function QuoteDetail() {
  ...
  const { qid, clientName, isHuelip } = location.state || {};
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden bg-gray-100">
        <Header
          title={`Quotations - QID: ${qid || "N/A"} - ${clientName || "Unknown Client"}`}
        ...
        <div className="bg-white px-4 py-1 border-b text-sm text-gray-700">
          ...
          <span className={`font-semibold ${isHuelip ? "text-green-600" : "text-gray-500"}`}>
        ...
        <div className="p-4 overflow-y-auto flex-1">
          {activeSection === "Summary" ? (
            ...
            <QuoteItemizedSection areaName={activeSection} isHuelip={isHuelip} />
          )}
        </div>
      </div>
      ...
      <Modal
        ...
        size="sm"
      >
        <h2 className="text-lg font-extrabold text-center text-red-700 mb-2">Add New Space</h2>
        <div className="border-2 border-black rounded-2xl px-4 py-3 space-y-4">
          {["Bedroom", "Living Room", "Toilet", "Pantry", "Store", "Balcony"].map((space) => (
            <div key={space} className="flex justify-between items-center">
              <label className="font-extrabold text-[16px]">{space}</label>
              <input type="checkbox" className="w-5 h-5 border-2 border-black rounded-sm accent-red-700" />
            </div>
          ))}
      ...
      <Modal
        ...
        className="p-4"
      >
        <div className="text-lg font-extrabold text-red-700 text-center mb-3">Import Template</div>
        <div className="px-4">
          <div className="overflow-x-auto border border-gray-300 rounded-xl">
            <table className="min-w-full text-sm text-left">
              ...
              <tbody>
                {[
                  ["RAKHI KUMAR", "L000556", "₹1,00,000", "+91-7000000000", "DELHI / KAKALA"],
                  ["RISHAB PANT", "L000556", "₹90,000", "+91-7000000001", "DELHI / RANI BAGH"],
                  ["SANA MIRZ", "L000556", "₹1,20,000", "+91-7000000002", "DELHI / NARET"],
                  ["RAJ KATOOR", "L000556", "₹85,000", "+91-7000000003", "JAIPUR / C SCHEME"],
                  ["RAJESH MITTAL", "L000556", "₹70,000", "+91-7000000004", "RANCHI / KADRU"],
                ].map((row, index) => (
      ...
      <Modal
        ...
        size="sm"
      >
        <h2 className="text-lg font-bold text-center text-red-700 mb-2">Actions</h2>
        <div className="border border-black rounded-xl px-6 py-5 space-y-4 text-left">
          {[
            ...
            { label: "Delete", icon: <FaTrash className="text-black text-lg" /> },
            { label: "Download", icon: <FaDownload className="text-black text-lg" /> },
            { label: "Export to Excel", icon: <FaFileExcel className="text-black text-lg" /> },
          ].map((item, idx) => (
