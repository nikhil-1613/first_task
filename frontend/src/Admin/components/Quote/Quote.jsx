    ...
    const loadQuotes = async () => {
      try {
        ...
        const normalized = data.map((item, index) => ({
          ...
          leadId: item.leadId?.id || "", // Display ID
          leadIdMongo: item.leadId?._id, // Mongo _id for updates
...
//           qid: item.qid,
//           id: item._id,                 // MongoDB ID
//           leadId: item.leadId?.id || "", // Normal ID for display
//           leadIdMongo: item.leadId?._id, // MongoDB _id for updates
//           name: item.leadId?.name || "",
//           budget: item.leadId?.budget || "",
//           contact: item.leadId?.contact || "",
//           quoteAmount: item.quoteAmount,
//           city: item.city || "",
//           assigned: item.assigned?.map((a) => a.name[0]) || [],
//           status: item.status,
//         }));
//         setLeads(normalized);
...
//       console.log("Quote ID:", editedData.id);
...
//         ...updatedQuote,
//         sno: editedData.sno,
//         leadId: editedData.leadId,      // keep normal ID for display
//         leadIdMongo: updatedQuote.leadId?._id,
//         assigned: updatedQuote.assigned?.map((a) => a.name[0]) || [],
//       };
...
//                   id: savedQuote._id,
//                   name: selectedClient.name,
//                   leadId: selectedClient.id,       // display ID
//                   leadIdMongo: savedQuote.leadId,  // Mongo _id
//                   budget: selectedClient.budget,
//                   contact: selectedClient.contact,
//                   quoteAmount: savedQuote.quoteAmount,
//                   city: savedQuote.location,
//                   assigned: savedQuote.assigned?.map((a) => a[0]) || [],
//                   status: savedQuote.status,
//                 };
