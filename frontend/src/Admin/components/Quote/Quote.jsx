        ...
        <div className="p-4 sm:p-6 flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <button
                className="flex items-center gap-2 border border-gray-400 text-gray-600 px-3 py-1.5 rounded-xl text-sm"
            ...
            <div key={quote.id} className="bg-white rounded-xl shadow">
              ...
              {openQuote === quote.id && (
                <div className="overflow-x-auto p-4">
                  ...
                  <button
                    onClick={() => navigate("/project/vendor  ")}
                    className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 ml-10 mt-10 "
                  >
                    Contact Vendor
                  </button>
                  {/* Summary */}
