...
import { typeColorMap, typeCategoryMap, fieldConfig, normalizeTransactionType } from "./allConfigs";
...
function TransactionModal({
  ...
  //       transaction.partyId = transaction.partyId._id;
  //     }
  //     if (transaction.vendorId && typeof transaction.vendorId === "object") {
  //       transaction.vendorId = transaction.vendorId._id;
  //     }
  ...
  //       payload = formDataObj;
  //       config = { headers: { "Content-Type": "multipart/form-data" } };
  //       console.log("📦 Transaction with FormData payload:", [
  //         ...formDataObj.entries(),
  //       ]);
  //     }
...
//       payload = formDataObj;
//       config = { headers: { "Content-Type": "multipart/form-data" } };
//       console.log("📦 Transaction with FormData payload:", [...formDataObj.entries()]);
//     }
