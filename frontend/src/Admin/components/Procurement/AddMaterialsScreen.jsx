...
function AddMaterialsScreen() {
  ...
  //   try {
  //     console.log("📦 Draft payload being sent:", draftData); // 👈 log payload
  //     toast.loading("Saving draft...");

  //     const res = await createRFQ(draftData); // capture response
  //     console.log("✅ Draft saved. Server response:", res); // 👈 log success
