...
import { addMaterialsToRFQ, getMaterialsOfRFQ } from "../../../services/rfqServices"; // ✅ import
...
export default function MaterialLibraryDrawer({
  ...
  onClose,
  selectedProject,
  rfqId,                     // ✅ pass rfqId from parent
  setMaterialGroups          // still used to keep parent in sync
}) {
