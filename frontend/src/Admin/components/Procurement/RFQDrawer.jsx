            ...
            <div className="flex border border-purple-200 rounded-full overflow-hidden">
              <button
                className={`px-6 py-1.5 text-sm font-medium ${
                  activeTab === "detail" ? "bg-red-600 text-white" : "text-red-700"
                }`}
              ...
              <button
                className={`px-6 py-1.5 text-sm font-medium ${
                  activeTab === "supplier" ? "bg-red-600 text-white" : "text-red-700"
                }`}
          ...
          {activeTab === "detail" && (
            <>
              ...
              <div className="grid grid-cols-2 gap-4 bg-purple-50 p-4 rounded-md text-sm">
                ...
                <div>
                  <strong>Document Date:</strong> {rfq?.createdAt ? formatDate(rfq.createdAt) : "--"}
                </div>
                <div>
                  <strong>Bidding Start Date:</strong> {rfq?.biddingStartDate ? formatDate(rfq.biddingStartDate) : "--"}
                </div>
                <div>
                  <strong>Bidding End Date:</strong> {rfq?.biddingEndDate ? formatDate(rfq.biddingEndDate) : "--"}
                </div>
              </div>
                    ...
                    {rfq?.materials?.length > 0 ? (
                      rfq.materials.map((item, idx) => (
                        <tr key={idx} className="border-t">
                          ...
                          <td className="p-2">{formatDate(item?.deliveryDate) || "--"}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
              ...
              {rfq?.terms && (
                <div className="mt-4 p-4 bg-gray-50 rounded-lg border text-sm text-gray-700 leading-relaxed">
                  <h4 className="font-semibold text-base mb-2">Terms & Conditions</h4>
