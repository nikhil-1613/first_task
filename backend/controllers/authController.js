...
// // Use full OAuth2 client for code exchange
// const oauth2Client = new OAuth2Client(
//   process.env.GOOGLE_CLIENT_ID,
//   process.env.GOOGLE_CLIENT_SECRET,
//   'postmessage' // redirect URI used for installed apps or JavaScript frontends
// );

// // @desc Register user manually
// // @route POST /api/auth/signup
// const registerUser = async (req, res) => {
//   try {
//     const { name, phoneNumber, email, password, role } = req.body;
...
// // @desc Login/Register via Google using auth-code
// // @route POST /api/auth/google
// const googleAuth = async (req, res) => {
//   try {
//     const { code } = req.body;
...
//         name,
//         email,
//         password: sub, // hashed sub can be used for internal fallback
//         role: 'client',
//         phoneNumber: '0000000000',
//       });
//     }
